...
Phase 1 of `docs/MASTER_PLAN.md` Part G (`tests/host/test_hann_window.c`)
proved a real bug in `src/dsp_task.c`'s FFT power-normalisation constant.
...
Hann-windowed spectrum read ~6.03 dB (`20*log10(0.5)`) low. The Phase 1
host test `nf_normalization_ignores_coherent_gain` documented this
